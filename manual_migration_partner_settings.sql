-- Manual Migration: Add Partner Settings Columns
-- Run this in Supabase Dashboard > SQL Editor
-- Project: VendorHubOs3 (kfdlxorqopnibuzexoko)
...
AND column_name IN ('company_logo', 'brand_color', 'notification_email', 'notification_sms', 'auto_approval', 'approval_threshold')
